...
export const FAQ: React.FC = () => {
  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      answer: 'Оставьте рабочую почту в форме. Приглашаем компании волнами и просим обратную связь по опыту использования.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Сейчас — нет. Рассматриваем интеграции после публичного запуска. Если для вас это важно, отметьте в заявке.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Да, к моменту публичного запуска.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Готовим публичный релиз после завершения раннего доступа и сбора кейсов.'
    }
  ];
