...
export const Header: React.FC = () => {
  return (
    <header className="w-full bg-[#F5F7FC]">
      <div className="flex w-[1308px] max-w-full items-center gap-[40px_100px] text-sm text-[#333338] font-normal leading-loose justify-between flex-wrap mx-auto px-5 py-5 max-md:px-5">
        <img
